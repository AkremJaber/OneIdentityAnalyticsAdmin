...
namespace OneIdentityAnalyticsAPI.Services
{
    ...
    public PowerBiServiceApi(IConfiguration configuration, ITokenAcquisition tokenAcquisition, OneIdentityAnalyticsDBService appOwnsDataDBService) {
